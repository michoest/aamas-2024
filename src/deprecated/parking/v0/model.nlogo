...
[
  ...
  allowed?        ;; true if parking here is currently allowed ;; MO
]
...
to setup-garages
  ...
  ask garages [set allowed? true] ;; MO
END
...
to-report navigate [current goal]
  ...
  let fav-lots []
  ;; let templots lots ;; MO
  let templots lots with [allowed?] ;; MO
